...
const joinOrgMemberInitialSetupJson = async(req,res,next)=>{
    ...
    try{
        ...
        if(!otpCode){
             const responseObj = new ResponseObj(true,Messages.CODE_VERIFICATION_FAILED);
            ...
            if(!checkActiveLink){
                ...
                const responseObj = new ResponseObj(true,Messages.CODE_VERIFICATION_FAILED,otpCode);
